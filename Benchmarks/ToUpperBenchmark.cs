...
public class ToUpperBenchmark : BenchmarkBase
{
    ...
    public int String()
    {
        ...
        {
            sum += strings[i].ToUpper(Culture).Length;
        }
        return sum;
    }
    ...
    public int Span()
    {
        ...
        for (int i = 0; i < strings.Length; i++)
        {
            sum += strings[i].AsSpan().ToUpper(destination, Culture);
        }
        return sum;
    }
    ...
    public int SpanAlloc()
    {
        ...
        for (int i = 0; i < strings.Length; i++)
        {
            strings[i].AsSpan().ToUpper(destination, Culture);
